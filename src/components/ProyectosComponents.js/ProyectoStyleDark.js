...
const ProyectoStyleDark = ({name, img, description, linkRepo, linkDeploy}) => {
        ...
        <Box bgColor={'blackAlpha.900'} boxShadow='base' borderRadius={'md'}>
            <Box  w='100%' h={{base: '250px', sm: '320px', md: '300px'}} >
                ...
                <Box w='100%' h='110px' p={2}>
                    <Text color={'white'} fontFamily={'sans-serif'} fontSize={{base: 'xs', sm: 'xs', md: 'xs', lg: 'sm'}} textAlign='center' fontWeight={'semibold'}>{`${name}: ${description}`}</Text>
                </Box>
                <Divider/>
...
export default ProyectoStyleDark